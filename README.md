...
## How to Play
Once the MCP server is installed in Claude Desktop, simply open a new chat and type:

**"start-defuse"**

Claude will automatically pull up the game manual and walk you through the process of creating a room, inviting friends, and starting the game!